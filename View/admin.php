        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="form-group">
                ...
                <input type="password" class="form-control" id="" readonly value="<?php ?>">
                <input type="text" id="" hidden="true" value="<?php ;?>">
            </div>
            <div class="form-group">
                <label for="exampleInputPassword1">Contraseña Nueva: <span class="glyphicon glyphicon-option-horizontal"></span></label>
                <input type="password" class="form-control" id="" placeholder="Ingrese ...">
            </div>
            <div class="form-group">
